...
OBJECTS += mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L476xG/TARGET_NUCLEO_L476RG/system_clock.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1577311020.89
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1577311020.89
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/1/1fce642106f3f728b2d5d353a0326e6d/Nucleo_rtos_basic/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
